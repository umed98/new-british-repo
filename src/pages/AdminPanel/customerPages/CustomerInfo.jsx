...
const CustomerInfo = () => {
  ...
  const handleAddOrder = () => {
    ...
    const chosenSpecialPrice =
      specialPrice.find((sp) => sp.id === selectedSpecialPriceId) || null;
    ...
    navigate("/add-order-auto", {
      state: {
        singleBusiness: customer.businesses,
        customer, // full customer object
        addresses: chosenAddresses,
        specialPrice: chosenSpecialPrice,
      },
    });
  };
  ...
  return (
    <div className="w-full z-0 pl-[220px] lg:pl-[270px] xl:pl-[330px] py-8 px-10 bg-[#F7F7F7]">
      ...
      <div className="bg-white p-8 rounded-[8px] shadow-lg">
        ...
        {/* Special Prices */}
        <div>
          <h2 className="text-xl font-semibold mt-4 mb-2">Special Prices</h2>
          {specialPrice.map((spl) => (
            ...
            >
              <input
                ...
                name="special_price"
                className="mt-1 accent-violet-700"
                checked={selectedSpecialPriceId === spl.id}
                onChange={() => setSelectedSpecialPriceId(spl.id)}
              />
              <div className="text-violet-900 font-[600]">
                <span className="text-gray-900 font-[500]">Variant ID</span>{" "}
                {spl.variant_id}
              </div>
              <div className="text-violet-900 font-[600]">
