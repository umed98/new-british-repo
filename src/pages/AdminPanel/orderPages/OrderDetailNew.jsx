...
const OrderDetailNew = () => {
  ...
  if (!order)
    return <p className="pl-[330px] mt-20">No order found with ID {id}</p>;
      ...
      <div className="bg-white rounded-[8px] p-6 ">
        ...
        <div className="mb-4">
          ...
          <p>
            ...
            {order.billing_address?.address_line2 || "N/A"}
          </p>
          <p>
            <strong>City:</strong>
        ...
        <div>
          ...
          {order.items.map((item) => (
            <div
              key={item.id}
              className="mb-2 p-4 border-1 border-gray-400 rounded-md"
            >
              <p>
              ...
              <p>
                <strong>Size: </strong> {item.size_label}
              </p>
              <p>
