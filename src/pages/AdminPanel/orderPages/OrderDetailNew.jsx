...
const OrderDetailNew = () => {
  const { id } = useParams(); // URL param like /orders/8
  ...
  useEffect(() => {
    const fetchOrders = async () => {
      try {
        const response = await axios.get("https://britishquilting.fastranking.tech/api/orders");
  ...
  useEffect(() => {
    if (!loading && orders.length > 0) {
      const matchedOrder = orders.find((item) => String(item.order_id) === id);
        ...
        <div className="bg-white flex flex-col rounded-[8px] w-full h-[80%] mt-5 pb-4">
          <div className="flex justify-between items-center w-full py-5 text-right bg-white px-5 rounded-t-[8px] border-b-1 border-[#dfdfdf]">
            <div className="flex flex-col">
              ...
              <h2 className="text-left text-[20px] font-[600] ">{order.order_id}</h2>
            </div>
          ...
          <div className="w-full flex gap-5 p-5">
            ...
            <div className="w-[25%] border border-gray-300 rounded-[8px] p-4 flex flex-col gap-5 justify-between bg-[#FFFFFA]">
              ...
              <div className="flex flex-col">
                <span className="text-[#838383] text-[14px]">Delivery In</span>
          ...
          <div className="flex flex-col md:flex-row gap-5 p-5 mx-5 shadow-sm rounded-[8px] border border-gray-200 bg-[#FFFFFA]">
            ...
            <div className="flex-1 border-r-1 border-gray-300">
              ...
              <div className="space-y-3 text-[14px] xl:text-[16px]">
                <div className="flex">
                  ...
                  <span className="font-[500]">{order.customer_name}</span>
                </div>
                <div className="flex">
                ...
                <div className="flex">
                  ...
                  <span className="mr-2">:</span>
                  <span className="font-[500]">{order.phone}</span>
                </div>
              </div>
            </div>
            ...
            <div className="flex-1">
              ...
              <h2 className="text-[18px] xl:text-[20px] font-[600] mb-2">
                Payment Method
              </h2>
              <div className="flex items-center space-x-3">
                ...
                <div className="leading-5">
                  ...
                  <p className="text-base">
                    ...
                    <span className="inline-block w-2 h-2 bg-black rounded-full mx-0.5" />
                    <span className="inline-block w-2 h-2 bg-black rounded-full mx-0.5" />
                    <span className="ml-1 text-[16px] xl:text-[18px] font-[500]">
                      8553
                    </span>
                  </p>
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              <div className="flex gap-3 items-center border-1 border-gray-200 rounded-[8px] p-3">
                ...
                <div className="flex flex-col justify-center gap-1">
                  <h1 className="text-black font-[500] text-[16px] xl:text-[18px]">
                    Linen
                  </h1>
                  <span className="text-[#a5a5a5] text-[15px] xl:text-[17px] font-[500]">
                    £89.00
                  </span>
