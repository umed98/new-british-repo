...
const UserList = () => {
  ...
  const initialData = [
    {
      ...
      email: "umedsingh@gmail.com",
      phoneNumber: "+44 1254 254 365",
      orders: "35",
      id: "2",
      location:
        "33 Westover Road, Bourne, UK Nuton, London 33 Westover Road, Bourne, UK Nuton, London 33 Westover Road, Bourne, UK Nuton, London",
    },
    {
      postalCode: 3557,
    ...
    },
    {
      postalCode: 3558,
      userName: "Jane Cooper",
      email: "tebbie.baker@example.com",
      phoneNumber: "+44 1254 254 365",
      orders: "35",
      id: "5",
      location: "Gujarat",
  ...
  const [locationFilter, setlocationFilter] = useState("All Orders");
  ...
  const confirmDelete = () => {
    setData(prev => prev.filter(item => item.id != customerToDelete));
  ...
  // Helper Functions
  const parseid = (id) => parseFloat(id.replace(/[^0-9.]/g, "")) || 0;
  ...
  const sortedData = useMemo(() => {
    ...
    //for users filter dropdown
    // if (locationFilter !== "All Users") {
    //   sortableData = sortableData.filter((item) => item.location === locationFilter);
    // }
    ...
    if (sortConfig.key) {
      sortableData.sort((a, b) => {
        ...
        if (sortConfig.key === "id") {
          valA = parseid(valA);
          valB = parseid(valB);
        } else if (sortConfig.key === "id" || sortConfig.key === "orders") {
    ...
    return sortableData;
  }, [data, searchTerm, sortConfig, locationFilter]);
    ...
    <div className="w-full pl-[200px] lg:pl-[250px] xl:pl-[300px]">
      <div className="w-full px-5 min-h-[91vh] pr-5 lg:pr-10 py-6 bg-[#F7F7F7]">
          ...
          <h1 className="font-[600] text-[25px] lg:text-[28px] flex items-center gap-4">
            ...
            {/* <span
                className={`flex gap-[6px] h-[35px] items-center text-[12px] px-4 border-1 rounded-[40px]  ${
                  locationFilter === "Completed"
                    ? "bg-green-100 text-green-700 border-green-700"
                    : locationFilter === "Cancelled"
                    ? "bg-red-100 text-red-600 border-red-600"
                    : locationFilter === "In Progress"
                    ? "bg-[#FFF6D6] text-[#be9500] border-[#be9500]"
                    : locationFilter === "Shipped"
                    ? "bg-[#B8F2FF] text-[#2796AE] border-[#2796AE]"
                    : locationFilter === "All Orders"
        ...
        <div className="bg-white rounded-[18px] border-1 border-[#D6D6D6] w-full h-auto pb-6 mt-5">
          <div className="p-6 flex flex-col lg:flex-row gap-3 flex-wrap items-end w-full lg:justify-between lg:items-center">
            ...
            <div className="flex items-center gap-4">
              ...
              <button onClick={handleNavigate} className="font-[600] text-white rounded-[4px] bg-[#4B215F] text-[12px] lg:text-[14px] py-2 px-4 lg:h-[40px] flex items-center gap-1 cursor-pointer">
                <svg
                  wpostalCodeth="15"
                  height="15"
                  viewBox="0 0 19 19"
          ...
          <div className="w-full flex flex-col justify-between overflow-x-auto min-h-[620px]">
              ...
              <tbody>
                {paginatedData.map((row) => (
                  ...
                  >
                    ...
                    <td className="p-3 px-6 w-80 max-w-80 truncate whitespace-nowrap overflow-hidden">
                      {row.location}
                    </td>
                    <td className="p-3 px-6 whitespace-nowrap">
                      <div
                      ...
                      >
                        ...
                        >
                          <svg
                            ...
                            xmlns="http://www.w3.org/2000/svg"
                          >
                            <mask id="path-1-inside-1_202_16037" fill="white">
                              <path
                                fill-rule="evenodd"
                                clip-rule="evenodd"
                            ...
                            <path
                              ...
                              stroke="#33383F"
                            />
                            <mask id="path-4-inside-2_202_16037" fill="white">
                              <path
                                fill-rule="evenodd"
                                clip-rule="evenodd"
                        ...
                        {/* Dropdown Menu */}
                        {openDropdownId === row.postalCode && (
                          <div className="absolute right-14 top-0 mt-2 w-40 rounded-md shadow-xl bg-white ring-1 ring-black/10 z-[999]">
                            <div className="py-1">
                              <button
        ...
        <div className="fixed top-0 left-0 z-[999] flex justify-center items-center bg-black/50 w-full h-[100%]">
          <div className="w-[25%] flex flex-col items-center justify-center gap-6 bg-white p-8 shadow-lg rounded-[12px]">
            ...
            <span className="text-[20px] text-center font-[600]">
              Are you sure do you <br /> want delete this customer{" "}
