...
<body>
            ...
            <div class="bg-center flex items-center text-center h-[300px] comman-banner">
                ...
                <div class="md:w-[100%]">
                    <h1
                        ...
                        Print
                        <span class="sm:hidden"></span> Media
                    </h1>
                </div>
            </div>
                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                    ...
                    <li>
                        <div class="flex items-center">
                            ...
                            <a href="print-media.php" class="ms-1 text-sm font-medium text-blue-main">Print Media</a>
                        </div>
                    </li>
                </ol>
            </div>
                    ...
                    <div>
                        ...
                        <div>
                            <div class="tabs sm:mt-10 ">
                                ...
                                <section id="section1" class="tab-panel mt-5" role="tabpanel" aria-hidden="false">

                                    <div id="printGrid" class="grid grid-cols-1 sm:grid-cols-3 gap-4 ">
                                    </div>
                                </section>
    ...
    <script>
        ...
        async function loadGallery() {
            try {
                const response = await fetch('https://allenhouseadmin.fastranking.tech/api/print-media/SCLID000004');
        ...
        function renderGallery(data) {
            ...
            data.forEach(item => {
                const coverImage = item.media?.urls || 'https://via.placeholder.com/300x200?text=No+Image';
                const title = item.printmediadetails[0]?.title || '';
                const dateStr = item.printmediadetails[0]?.date || null;
                ...
                const card = `
        <div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow hover:shadow-lg transition-shadow duration-300">
            <a href="#">
                <img class="rounded-t-lg w-full h-[200px] object-cover" src="${coverImage}" alt="${title}" />
                <div class="p-4">
                    <div class="flex gap-4">
                        ...
                        <div class="w-[70%]">
                            <div class="text-blue-main text-[1rem] font-bold mb-2">${title}</div>
                            <hr>
                            <div class="text-[9px] text-[#3B3B3B] mt-2">
                                <div>Category: <strong>${item.categories?.[0]?.categoryname || 'N/A'}</strong></div>
                                <div>School: <strong>${item.school?.schoolname || 'N/A'}</strong></div>
                            </div>
                        </div>
                    </div>
                    <a href="gallery.php?id=${media_id}&type=print-media">
                        <button class="group mt-5 py-1 px-4 sm:px-6 w-full border text-blue-main border-gray rounded-[10px] hover:bg-[#053B7A] hover:text-white flex gap-2 items-center justify-center">
                            View More
