...
<head>
    ...
    <title>AllenHouse Jhansi| Home</title>
...
<body style="overflow-x: hidden;">
    ...
    <div id="formOverlay"
        ...
        <div class="bg-white rounded-xl shadow-2xl p-6 w-full lg:max-w-xl md:max-w-lg sm:max-w-md relative">
            ...
            <img src="https://res.cloudinary.com/dj7wogsju/image/upload/v1747746755/APS_JHNS_POP_UP_BANNER_1x1_bty6gz.jpg"
                alt="">
        </div>
    </div>
            ...
            <div class="relative w-full heroSlider opne-hide-circle">
                <div class="overflow-hidden" data-glide-el="track">
                    <ul
                        ...
                        <li class="relative">
                            <img src="https://res.cloudinary.com/digy74izv/image/upload/v1748074816/APS_JHS_Website_Hero_Banner_mobile_2_xc1nig.jpg"
                                alt="Experience Excellence" class="sm:w-auto w-[100%] sm:hidden ">
                            <img src="https://res.cloudinary.com/digy74izv/image/upload/v1748074823/APS_JHS_Website_Hero_Banner_2_zsri4h.jpg"
                        ...
                        <li class="relative">
                            <img src="https://res.cloudinary.com/digy74izv/image/upload/v1748074817/APS_JHS_Website_Hero_Banner_mobile_3_qer10h.jpg"
                                alt="Experience Excellence" class="sm:w-auto w-[100%] sm:hidden ">
                            <img src="https://res.cloudinary.com/digy74izv/image/upload/v1748074817/APS_JHS_Website_Hero_Banner_3_zxxi39.jpg"
                                alt="Experience Excellence" class="w-[100%] hidden sm:block">
                            <div class="absolute top-5 left-4 sm:top-[75px] sm:left-[180px] hidden">
                                <h2 class="text-gray-500 sm:text-4xl text-3xl font-[700]">
                                    Experience <br>
                        ...
                        <li class="relative">
                            <img src="https://res.cloudinary.com/digy74izv/image/upload/v1748074817/APS_JHS_Website_Hero_Banner_mobile_4_gq1nku.jpg"
                                alt="Experience Excellence" class="sm:w-auto w-[100%] sm:hidden ">
                            <img src="https://res.cloudinary.com/digy74izv/image/upload/v1748074818/APS_JHS_Website_Hero_Banner_4_mle8w6.jpg"
                                alt="Experience Excellence" class="w-[100%] hidden sm:block">
                            <div class="absolute top-5 left-4 sm:top-[75px] sm:left-[180px] hidden">
                                <h2 class="text-gray-500 sm:text-4xl text-3xl font-[700]">
                                    Experience <br>
                        ...
                        <li class="relative">
                            <img src="https://res.cloudinary.com/digy74izv/image/upload/v1748074816/APS_JHS_Website_Hero_Banner_mobile_1_shyi0u.jpg"
                                alt="Experience Excellence" class="sm:w-auto w-[100%] sm:hidden ">
                            <img src="https://res.cloudinary.com/digy74izv/image/upload/v1748074819/APS_JHS_Website_Hero_Banner_1_jhwqjd.jpg"
                                alt="Experience Excellence" class="w-[100%] hidden sm:block">
                            <div class="absolute top-5 left-4 sm:top-[75px] sm:left-[180px] hidden">
                                <h2 class="text-gray-500 sm:text-4xl text-3xl font-[700]">
                                    Experience <br>
            ...
            <div class="grid sm:grid-cols-4 grid-cols-1 gap-5">
                <div class="overflow-hidden">
                    <div class="relative w-full card-top-peudo rounded-[8px] cursor-pointer">
                        ...
                        <div>
                            <img src="https://res.cloudinary.com/dj7wogsju/image/upload/v1747993527/Untitled-2_1_z8x5ma.jpg"
                                class="w-[100%]" alt="">
                        </div>
            ...
            <div
                ...
                <div class="text-center">
                    ...
                    <p class="mt-4 text-[#808080] text-[18px]">
                        We aim to prepare students for a future full of possibilities by empowering them to excel
                        academically, socially and emotionally. We believe that an education that integrates Indian
                        culture and values with a global perspective will shape students into compassionate global
                        citizens.</p>
                </div>
            </div>
        </div>
        ...
        <div class="relative w-full glide-0222 mt-5 opne-hide-circle">
            <div class="overflow-hidden" data-glide-el="track">
                <ul
                    class="relative w-full overflow-hidden  p-0 whitespace-no-wrap flex flex-no-wrap [backface-visibility: hidden] [transform-style: preserve-3d] [touch-action: pan-Y] [will-change: transform]">
                    <li>
                        <img src="https://res.cloudinary.com/digy74izv/image/upload/v1748939177/3_ndu1uc.jpg"
                            alt="A Multidimensional
                                Approach to Education" class="w-[100%] rounded-[12px]">
                        <div class="mt-4">
                    ...
                    <li>
                        <img src="https://res.cloudinary.com/digy74izv/image/upload/v1748939177/5_u8tdzw.jpg"
                            alt="Holistic Development" class="w-[100%] rounded-[12px]">
                        <div class="mt-4">
                    ...
                    <li>
                        <img src="https://res.cloudinary.com/digy74izv/image/upload/v1748939178/23_n2qqks.jpg"
                            alt="Innovative Curriculum" class="w-[100%] rounded-[12px]">
                        <div class="mt-4">
                            ...
                            <p class="text-gray-600 text-[16px] mt-1">A blend of advanced academics, creative
                                co-curricular activities and practical life skills, focuses on emerging technologies,
                                entrepreneurship and global awareness</p>
                        </div>
                    </li>
                    <li>
                        <img src="https://res.cloudinary.com/digy74izv/image/upload/v1748939177/4_ylozot.jpg"
                            alt="Supportive Learning Environment" class="w-[100%] rounded-[12px]">
                        <div class="mt-4">
                    ...
                    <li>
                        <img src="https://res.cloudinary.com/digy74izv/image/upload/v1748939177/28_ckcavl.jpg"
                            alt="Experiential Learning" class="w-[100%] rounded-[12px]">
                        <div class="mt-4">
    ...
    <div style="background-image: url('https://res.cloudinary.com/dj7wogsju/image/upload/v1745924133/Rectangle_7157_j4cj0a.png');  background-repeat: no-repeat;"
     ...
     <!-- <div>
        ...
        <div class="mt-5 sm:flex sm:justify-center sm:items-center sm:mx-[100px] sm:px-0 px-3 gap-20">
            <div class="sm:w-[30%]">
                <img src="https://res.cloudinary.com/dj7wogsju/image/upload/v1747749248/Cambridge_logo_1_qnz2l0.png"
                    alt="">
            </div>

            <div class="w-[40%]">
                <div>
                    <p class="mt-5 text-gray-600"><strong>Cambridge Assessment English</strong> is a unique approach to
                        teaching, learning and assessing English. It combines the experience and expertise
                        of the <strong>Cambridge English</strong> Language Assessment.</p>
                    <p class=" mt-5 text-gray-600"><strong>Cambridge English</strong> is driven by world-class research
                        and a profound commitment to </p>
                    <ul class="text-sm mt-2 sm:ml-5 text-gray-600" style="list-style:disc;">
                        <li>Delivering educational excellence.</li>
                        <li>Providing increased opportunities for learners and teachers.</li>
                        <li>Offering value to teachers, educational institutions and employers.</li>
                        <li>Promoting language learning to benefit society </li>
            ...
            <div class="relative ">
                <div class="o-video mx-auto">
                    <iframe width="560" height="315"
                        src="https://www.youtube.com/embed/jzajsqOlqSQ?autoplay=1&mute=1&loop=1&playlist=jzajsqOlqSQ"
                    ...
                    <ul
                        ...
                        <li class="bg-white mb-5 rounded-[10px]"
                            ...
                            <img src="assets/images/Allenhouse-Khalasi-Lines.jpg" alt="Allenhouse Khalasi Lines"
                                class="w-[100%] rounded-[10px]">
                            <div class="mx-3 mt-4 mb-5">
                                <h2 class="text-[22px] font-[700] leading-8 text-blue-main">Allenhouse Public School </h2>
                                <div class="mt-3">
                                    <div class="flex gap-3">
                                        <span class="mt-1">
                                            <img src="https://res.cloudinary.com/dvzfuapyy/image/upload/v1730307962/fi-rs-map-marker_znpaah.png"
        ...
        <div class="mx-5 mt-7">
            <div class="sm:flex gap-3">
                <div class="sm:w-[33.33%]">
                    <div>
                        <a><img src="https://res.cloudinary.com/digy74izv/image/upload/v1748939949/Untitled-1_3_stnfjt.jpg" alt="student 1"
                                class="popup-img rounded-[10px] mb-2 object-cover hover:scale-90 transition delay-300"
                                style="width:100%"></a>
                    </div>
                    <div class="mt-3">
                        <a><img src="https://res.cloudinary.com/digy74izv/image/upload/v1748939948/4_tcpvts.jpg" alt="student 2"
                                class="popup-img rounded-[10px] mb-2 object-cover hover:scale-90 transition delay-300"
                                style="width:100%"></a>
                    </div>
                </div>
                ...
                <div class="w-[33.33%] sm:block hidden">
                    <div>
                        <a><img src="https://res.cloudinary.com/digy74izv/image/upload/v1748939948/10_jgiwmg.jpg" alt="student 4"
                                class="popup-img rounded-[10px] mb-2 hover:scale-90 transition delay-300"
                                style="width:100%"></a>
                    </div>
                    <div class="mt-3">
                        <a><img src="https://res.cloudinary.com/digy74izv/image/upload/v1748939949/Untitled-1_4_bsmtdl.jpg" alt="student 5"
                                class="popup-img rounded-[10px] mb-2 hover:scale-90 transition delay-300"
                                style="width:100%"></a>
                    </div>
                    <div>
            ...
            <div class="mt-[6px] sm:flex gap-3">
                <div>
                    <a><img src="https://res.cloudinary.com/digy74izv/image/upload/v1748940640/2_1_mmizpp.jpg" alt="student 7"
                            class="popup-img rounded-[10px] mb-2 hover:scale-90 transition delay-300"
                            style="width:100%"></a>
                </div>
                <div>
                    <a><img src="https://res.cloudinary.com/digy74izv/image/upload/v1748940641/image_1_yfdcof.jpg" alt="student 8"
                            class="popup-img rounded-[10px] mb-2 hover:scale-90 transition delay-300"
                            style="width:100%"></a>
                </div>
            </div>
                    ...
                    <div class="overflow-hidden mt-1" data-glide-el="track">
                        <ul
                            ...
                            <li class="flex items-start gap-10 mb-4">
                                <div class="flex">
                                    <div><img src="https://res.cloudinary.com/digy74izv/image/upload/v1748939356/3_1_hsklrn.jpg" alt="Image 1"></div>
                                </div>
                            </li>
                            <li class="flex items-start gap-10 mb-4">
                                <div class="flex">
                                    <div><img src="https://res.cloudinary.com/digy74izv/image/upload/v1748939364/27_mk8uqj.jpg" alt="Image 2"></div>
                                </div>
                            </li>
                            <li class="flex items-start gap-10 mb-4">
                                <div class="flex">
                                    <div><img src="https://res.cloudinary.com/digy74izv/image/upload/v1748939363/25_yur2ad.jpg" alt="Image 3"></div>
                                </div>
                            </li>
                            <li class="flex items-start gap-10 mb-4">
                                <div class="flex">
                                    <div><img src="https://res.cloudinary.com/digy74izv/image/upload/v1748939363/14_gn4ihg.jpg" alt="Image 4"></div>
                                </div>
                            </li>
                            <li class="flex items-start gap-10 mb-4">
                                <div class="flex">
                                    <div><img src="https://res.cloudinary.com/digy74izv/image/upload/v1748939367/Untitled-1_2_wz9udu.jpg" alt="Image 5"></div>
                                </div>
                            </li>
                        </ul>
                    </div>
