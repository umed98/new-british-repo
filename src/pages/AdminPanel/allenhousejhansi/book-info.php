...
<head>
    ...
    <title>AllenHouse Jhansi| Book Info</title>
        ...
        <div class="bg-center flex items-center text-center h-[300px] common-banner">
            ...
            <div class="md:w-[100%]">
                <h1
                    ...
                    Book
                    <span class="sm:hidden"></span>Info
                </h1>
            </div>
        </div>
            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <a href="book-info.php" class="ms-1 text-sm font-medium text-blue-main">Book Info</a>
                    </div>
                </li>
            </ol>
        </div>
        ...
        <div class="my-10">
            ...
            <div class="mt-8 mx-3 2xl:w-[1280px] lg:w-[1024px] md:w-[767px] sm:w-[640px] sm:mx-auto sm:px-5 px-3">
                <div class="overflow-x-auto">
                    <table class="min-w-full text-sm text-left rtl:text-right text-gray-600">
                        <table class="w-full text-sm text-left rtl:text-right text-gray-600 ">
                            ...
                            <tbody>
                                <tr class="odd:bg-white even:bg-gray-50  border-b dark:border-gray-700">
                                    ...
                                    <td class="px-6 py-2">
                                        <a href="New BookList 25_26.pdf" target="_blank"
