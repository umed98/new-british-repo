...
<head>
    ...
    <title>AllenHouse jhansi| Student's Achievements</title>
                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                    ...
                    <li>
                        <div class="flex items-center">
                            ...
                            <a href="student’s-achievement.php"
                                class="ms-1 text-sm font-medium text-blue-main">Student's Achievements</a>
                        </div>
                    </li>
                </ol>
            </div>
