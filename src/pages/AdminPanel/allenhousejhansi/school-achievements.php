...
<head>
    ...
    <title>AllenHouse Jhansi| School Achievements</title>
            ...
            <div class="bg-center flex items-center text-center h-[300px] comman-banner">
                ...
                <div class="md:w-[100%]">
                    <h1
                        ...
                        School
                        <span class="sm:hidden"></span> Achievements
                    </h1>
                </div>
            </div>
                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                    ...
                    <li>
                        <div class="flex items-center">
                            ...
                            <p class="ms-1 text-sm font-medium text-blue-main">Achievements</a>
                        </div>
                    </li>
                    <li>
                        <div class="flex items-center">
                            ...
                            <a href="school-achievements.php" class="ms-1 text-sm font-medium text-blue-main">School
                                Achievements</a>
                        </div>
                    </li>
                </ol>
                    ...
                    <div>
                        ...
                        <div>
                            ...
                            <div class="tabs sm:mt-10 ">
                                ...
                                <section id="section1" class="tab-panel  block mt-5" role="tabpanel" aria-hidden="true">
                                     NOT PROVIDED
                                </section>
                                <script>
                                async function fetchAchievements() {
                                    try {
                                        const response = await fetch(
                                            "https://allenhouseadmin.fastranking.tech/api/achievements/SCLID000003"
                                            );
                                        ...
                                        if (data.data.length > 0) {
                                            data.data.forEach(achievement => {
                                                ...
                                                const coverMedia = achievement.medias.find(media => media
                                                    .pivot.is_cover === "1");
                                                console.log(coverMedia)
                                                const coverImageUrl = coverMedia ? coverMedia.urls :
                                                    "https://res.cloudinary.com/dj7wogsju/image/upload/v1735304436/Banner_200000001202411191269766_oyy43q.jpg";
                         ...
                         `;
                                        ...
                                        document.getElementById("achievementsContainer").innerHTML =
                                            "<p class='text-center text-red-500'>Failed to load achievements.</p>";
                                    }
                                }
