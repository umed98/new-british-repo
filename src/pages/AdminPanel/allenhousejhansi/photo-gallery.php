...
<head>
    ...
    <title>AllenHouse Jhansi| Photo Gallery</title>
                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                    ...
                    <li>
                        <div class="flex items-center">
                            ...
                            <a href="photo-gallery.php" class="ms-1 text-sm font-medium text-blue-main">Photo
                                Gallery</a>
                        </div>
                    </li>
                </ol>
    ...
    <?php include "includes/foot.php" ?>
     ...
     <script>
        ...
        async function loadGallery() {
            const response = await fetch('https://allenhouseadmin.fastranking.tech/api/photo-gallery/SCLID000004');
        ...
        function renderGallery(data) {
            ...
            data.forEach(item => {
                ...
                <div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow hover:shadow-[rgba(0,0,0,0.15)_0px_15px_25px,rgba(0,0,0,0.05)_0px_5px_10px] transition-shadow duration-300">
                    <a href="gallery.php?id=${media_id}">
                        ...
                        <div class="sm:p-4 p-1 flex flex-col justify-between relative">
                            ...
                            <a href="gallery.php?id=${media_id}&type=photo-gallery">
